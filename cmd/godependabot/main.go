...
func run() error {
	...
	const legacyBeginGeneratedComment = "  # Following lines generated by gomoddependabot; DO NOT EDIT."
	...
	// Remove the legacy marker from the old gomoddependabot tool (if present).
	if start := slices.Index(lines, legacyBeginGeneratedComment); start != -1 {
		lines = slices.Delete(lines, start, start+1)
	}
