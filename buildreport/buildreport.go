...
const localTempBranch = "refs/heads/buildreport-temp"

const releaseBuildPipelineName = "microsoft-go-infra-release-build"
const releaseImagesPipelineName = "microsoft-go-infra-release-go-images"
