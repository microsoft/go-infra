...
type Arch struct {
	...
	// PGPSignatureURL is the URL of a binary PGP signature file (.sig) for this artifact, commonly
	...
	// ASCSignatureURL is the URL of an ASCII-armored PGP signature file (.asc) for this artifact.
	//
